...
namespace AtomUIGallery.Workspace.Localization.CaseNavigationLang
{
    internal static class CaseNavigationLangResourceKey
    {
        ...
        public static readonly LanguageResourceKey DataDisplay_ImagePreviewer = new LanguageResourceKey("CaseNavigation.DataDisplay_ImagePreviewer", "AtomUIGallery");
        ...
        public static readonly LanguageResourceKey DataDisplay_Statistic = new LanguageResourceKey("CaseNavigation.DataDisplay_Statistic", "AtomUIGallery");
        ...
        public static readonly LanguageResourceKey DataEntry_Cascader = new LanguageResourceKey("CaseNavigation.DataEntry_Cascader", "AtomUIGallery");
        ...
        public static readonly LanguageResourceKey DataEntry_Form = new LanguageResourceKey("CaseNavigation.DataEntry_Form", "AtomUIGallery");
        ...
        public static readonly LanguageResourceKey DataEntry_Mentions = new LanguageResourceKey("CaseNavigation.DataEntry_Mentions", "AtomUIGallery");
        ...
        public static readonly LanguageResourceKey DataEntry_Transfer = new LanguageResourceKey("CaseNavigation.DataEntry_Transfer", "AtomUIGallery");
        public static readonly LanguageResourceKey DataEntry_TreeSelect = new LanguageResourceKey("CaseNavigation.DataEntry_TreeSelect", "AtomUIGallery");
        public static readonly LanguageResourceKey DataEntry_Upload = new LanguageResourceKey("CaseNavigation.DataEntry_Upload", "AtomUIGallery");
        ...
        public static readonly LanguageResourceKey Feedback_Result = new LanguageResourceKey("CaseNavigation.Feedback_Result", "AtomUIGallery");
        ...
        public static readonly LanguageResourceKey Layout_Space = new LanguageResourceKey("CaseNavigation.Layout_Space", "AtomUIGallery");
        public static readonly LanguageResourceKey Layout_Splitter = new LanguageResourceKey("CaseNavigation.Layout_Splitter", "AtomUIGallery");
    ...
    public class CaseNavigationLangResourceKeyExtension : LanguageResourceExtension<CaseNavigationLangResourceKind>
    {
        public CaseNavigationLangResourceKeyExtension()
        {
        }

        public CaseNavigationLangResourceKeyExtension(CaseNavigationLangResourceKind kind) : base(kind)
        {
        }
    }
}
...
namespace AtomUIGallery.Workspace.Localization.WorkspaceWindowLang
{
    ...
    public class WorkspaceWindowLangResourceKeyExtension : LanguageResourceExtension<WorkspaceWindowLangResourceKind>
    {
        public WorkspaceWindowLangResourceKeyExtension()
        {
        }

        public WorkspaceWindowLangResourceKeyExtension(WorkspaceWindowLangResourceKind kind) : base(kind)
        {
        }
    }
}