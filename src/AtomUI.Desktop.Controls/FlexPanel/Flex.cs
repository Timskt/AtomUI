...
public static class Flex
{
    ...
    internal static double GetMinLength(Layoutable layoutable)
    {
        if (layoutable is null)
        {
            throw new ArgumentNullException(nameof(layoutable));
        ...
        return layoutable.GetValue(MinLengthProperty);
    }

    internal static void SetMinLength(Layoutable layoutable, double value)
    {
        if (layoutable is null)
        {
            throw new ArgumentNullException(nameof(layoutable));
        ...
        layoutable.SetValue(MinLengthProperty, value);
    }
