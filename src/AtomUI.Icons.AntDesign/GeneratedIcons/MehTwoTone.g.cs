...
public class MehTwoTone : AntDesignIcon
{
    public MehTwoTone()
    {
...
,         new PathDrawingInstruction()
        {
            Data = StreamGeometry.Parse("M288 421a48 48 0 1 0 96 0 48 48 0 1 0-96 0zm376 144H360c-4.4 0-8 3.6-8 8v48c0 4.4 3.6 8 8 8h304c4.4 0 8-3.6 8-8v-48c0-4.4-3.6-8-8-8zm-24-144a48 48 0 1 0 96 0 48 48 0 1 0-96 0z"),
            FillBrush = IconBrushType.Stroke,
        }
    ];
